...
print(charges.size)
base = '/Users/leobailloeul/Documents/coding/decaysimulation/decay/output-data'
...
plt.plot(10, 5, color='greenyellow', label='2 layers, 16 bars/layer, bkg = 20')

plt.contour(mass, charge, total_dune, levels=[21], colors = 'tomato')
plt.plot(10, 5, color='tomato', label='2 layers, 16 bars/layer, bkg = 100')

plt.contour(mass, charge, total_dune, levels=[29], colors = 'skyblue')
plt.plot(10, 5, color='skyblue', label='2 layers, 16 bars/layer, bkg = 200')

plt.contour(mass, charge, total_dune, levels=[45], colors = 'cyan')
plt.plot(10, 5, color='cyan', label='2 layers, 16 bars/layer, bkg = 500')

plt.contour(mass, charge, total_dune, levels=[63], colors='orange')
plt.plot(10, 5, color='orange', label='2 layers, 16 bars/layer, bkg = 1000')
...
plt.savefig('limit-plot-DarkQuest-' + str(NPOT) + '.png')
