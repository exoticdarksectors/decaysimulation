...
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.22, 2024-11-29
...
C     
C     Process: s s~ > chi chi~ WEIGHTED<=4 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
        IF(ZERO.NE.0D0) FK_ZERO = SIGN(MAX(ABS(ZERO), ABS(MDL_MCHI
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
      ...
      CALL OXXXXX(P(0,3),MDL_MCHI,NHEL(3),+1*IC(3),W(1,3))
      CALL IXXXXX(P(0,4),MDL_MCHI,NHEL(4),-1*IC(4),W(1,4))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_1,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_52,AMP(1))
      CALL FFV2_3_3(W(1,1),W(1,2),GC_69,GC_77,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_79,AMP(2))
