...
# masses SHIP vs Dark
mass = np.loadtxt('/Users/leobailloeul/Documents/coding/decaysimulation/plotting/sensitivity-plot/mchi_values.txt')
# mass = np.loadtxt('/Users/leobailloeul/Documents/coding/decaysimulation/plotting/sensitivity-plot/mchi_values.txt')
...
mesonDecay_dune = list(mesonDecayProduction(base + 'total_efficiency_outputdecayPion_SHIP-1m.txt',
...
# get DY production Dark vs SHIP
# dy_dune = dyProduction(base+'ageo_dy.txt', base+'dy_cross.txt', NPOT, charges, 2)
dy_dune = dyProduction(base+'ageo_dy_ship_0.5m_final.txt', base+'dy_cross_ship_final.txt', NPOT, charges, 3)
...
# plt.contour(mass, charge, total_dune, levels=[2], colors = 'greenyellow')
# plt.plot(10, 5, color='greenyellow', label='3 layers, 0.5 m radius (~ 315 bars/layer), bkg = 1')
#
# plt.contour(mass, charge, total_dune, levels=[7], colors = 'tomato')
# plt.plot(10, 5, color='tomato', label='3 layers, 0.5 m radius (~ 315 bars/layer), bkg = 10')

# plt.contour(mass, charge, total_dune, levels=[10], colors = 'greenyellow')
# plt.plot(10, 5, color='greenyellow', label='2 layers, 1 m radius (~ 1257 bars/layer), bkg = 20')
#
# plt.contour(mass, charge, total_dune, levels=[21], colors = 'tomato')
# plt.plot(10, 5, color='tomato', label='2 layers, 1 m radius (~ 1257 bars/layer), bkg = 100')
#
# plt.contour(mass, charge, total_dune, levels=[29], colors = 'skyblue')
# plt.plot(10, 5, color='skyblue', label='2 layers, 1 m radius (~ 1257 bars/layer), bkg = 200')
#
# plt.contour(mass, charge, total_dune, levels=[45], colors = 'cyan')
# plt.plot(10, 5, color='cyan', label='2 layers, 1 m radius (~ 1257 bars/layer), bkg = 500')
#
# plt.contour(mass, charge, total_dune, levels=[63], colors='orange')
# plt.plot(10, 5, color='orange', label='2 layers, 1 m radius (~ 1257 bars/layer), bkg = 1000')
#
# plt.contour(mass, charge, total_dune, levels=[201], colors='purple')
# plt.plot(10, 5, color='purple', label='2 layers, 1 m radius (~ 1257 bars/layer), bkg = 10000')

#

plt.contour(mass, charge, total_dune, levels=[3.09], colors = 'skyblue', linewidths = 3)
plt.plot(10, 5, color='skyblue', label='3 layers, 315 bars/layer, bkg = 0')

# plt.contour(mass, charge, total_dune, levels=[8.72], colors = 'salmon', linewidths = 3)
# plt.plot(10, 5, color='salmon', label='3 layers, 315 bars/layer, bkg = 12')
...
#
# plt.contour(mass, charge, total_dune, levels=[347], colors='darkgreen')
# plt.plot(10, 5, color='darkgreen', label='2 layers, 0.5 m radius (~ 315 bars/layer), bkg = 30 000')

# plt.contour(mass, charge, total_dune, levels=[775], colors='darkgreen')
# plt.plot(10, 5, color='darkgreen', label='2 layers, 0.5 m radius (~ 315 bars/layer), bkg = 150 000')
...
plt.savefig('limit-plot-SHiP-' + str(NPOT) + '.pdf')
...
#
# plt.contour(mass, charge, total_dune, levels=[64], colors='orange')
# plt.plot(10, 5, color='orange', label='2 layers, 80 bars/layer, bkg = 1000')
#
# plt.contour(mass, charge, total_dune, levels=[201], colors='orange')
# plt.plot(10, 5, color='orange', label='2 layers, 80 bars/layer, bkg = 10000')
#
# plt.contour(mass, charge, total_dune, levels=[448], colors='orange')
# plt.plot(10, 5, color='orange', label='2 layers, 80 bars/layer, bkg = 50000')
#
