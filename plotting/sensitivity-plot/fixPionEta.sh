...
"${base_directory}/mesongen/output-data/DQprototypePi0.root"
"${base_directory}/mesongen/output-data/DQprototypeEta.root"
)
three_body_output_file=(
"${base_directory}/decay/output-data/DQ-production40mPi0.root"
"${base_directory}/decay/output-data/DQ-production40mEta.root"
)
...
total_efficiency_output_three_body=(
  "${base_directory}/decay/sensitivity-plot/DQ-total_efficiency_outputdecayPion1m.txt"
  "${base_directory}/decay/sensitivity-plot/DQ-total_efficiency_outputdecayEta1m.txt"
)
