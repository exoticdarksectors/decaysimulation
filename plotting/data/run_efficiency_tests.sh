...
two_body_input_files=(
    "${base_directory_archive}/mesongen-backup/output-data/mesonfinal2.root"
...
two_body_output_files=(
    "${base_directory}/data-backup/1040mcp-production-decay-vector-meson-jsi-testing.root"
...
efficiency_output_2bodydecay=(
    "TwoByTwoefficiency-output2bodydecay-jsi-testing.txt"
...
total_efficiency_output_2bodydecay=(
    # "${base_directory_archive}/data-backup/total_efficiency_output2body_decay-jsi-4by4.txt"
    # "${base_directory_archive}/data-backup/total_efficiency_output2bodydecay-rho-4by4.txt"
    # "${base_directory_archive}/data-backup/total_efficiency_output2bodydecay-omega-4by4.txt"
    # "${base_directory_archive}/data-backup/total_efficiency_output2bodydecay-phi-4by4.txt"
    "${base_directory_archive}/data-backup/total_efficiency_output2body_decay-jsi.txt"
    "${base_directory_archive}/data-backup/total_efficiency_output2bodydecay-rho.txt"
    "${base_directory_archive}/data-backup/total_efficiency_output2bodydecay-omega.txt"
    "${base_directory_archive}/data-backup/total_efficiency_output2bodydecay-phi.txt"
)
...
total_efficiency_output_three_body=(
  # "${base_directory_archive}/data-backup/total_efficiency_outputdecayPion-4by4.txt"
  # "${base_directory_archive}/data-backup/total_efficiency_outputdecayEta-4by4.txt"
  "${base_directory_archive}/data-backup/total_efficiency_outputdecayPion.txt"
  "${base_directory_archive}/data-backup/total_efficiency_outputdecayEta.txt"
)
...
# total_efficiency_output_2bodydecay=(
#    "${base_directory}/plotting/sensitivity-plot/total_efficiency_output2bodydecay-jsi-SHIP-1m-small.txt"
#    "${base_directory}/plotting/sensitivity-plot/total_efficiency_output2bodydecay-rho-SHIP-1m-small.txt"
#    "${base_directory}/plotting/sensitivity-plot/total_efficiency_output2bodydecay-omega-SHIP-1m-small.txt"
#    "${base_directory}/plotting/sensitivity-plot/total_efficiency_output2bodydecay-phi-SHIP-1m-small.txt"
# )
...
# total_efficiency_output_three_body=(
#  "${base_directory}/plotting/sensitivity-plot/total_efficiency_outputdecayPion_SHIP-1m-small.txt"
#  "${base_directory}/plotting/sensitivity-plot/total_efficiency_outputdecayEta_SHIP-1m-small.txt"
# )
# declare -a three_body_masses
# three_body_masses=(
# "0.1349768"
